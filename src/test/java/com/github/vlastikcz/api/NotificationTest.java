...
public class NotificationTest {
    ...
    @Test
    public void notificationIsProperlySerialized() throws Exception {
        ...
        final String expected = objectMapper.readValue(fixture("fixtures/notification.json"), JsonNode.class).toString();
        assertEquals(expected, objectMapper.writeValueAsString(notification));
    }
